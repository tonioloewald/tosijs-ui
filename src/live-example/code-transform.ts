...
const isCapturableName = (name: string): boolean =>
  /^[A-Za-z_$][\w$]*$/.test(name) && !RESERVED.has(name)
 ...
 */
export function buildScopeCapture(names: string[], captureVar: string): string {
