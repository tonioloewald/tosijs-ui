      ...
      button(
        {
          onClick() {
            const index = ideas.findIndex(
              (idea) => idea.value === suzy.icon.value
            )
            suzy.icon =
              ideas[
                index > -1 && index < ideas.length - 1 ? index + 1 : 0
              ].value
          },
        },
        icons.chevronRight()
