# TODO archive — 2026-09-26

The full `TODO.md` as it stood before it was pruned to live tasks (ahead of moving tasks onto the
virta board). **A record, not a task list:** measurements, evidence, design reasoning, decisions
and finished work, kept verbatim so nothing is re-derived. Live items were carried into
`TODO.md` with a pointer back here.

---

# TODO (as of 2026-09-26)
