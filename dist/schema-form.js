...
export class TosiSchemaForm extends WebComponent {
    ...
    */
    buildPluginField(node, plugin) {
        ...
        const wrapper = div({ class: 'schema-field' }, label(node.label), control, ...this.unvalidatedNote(node), errorSlot);
    ...
    buildField(field) {
        ...
        */
        ...
        const errorSlot = span({ class: 'schema-error', hidden: true });
        const wrapper = div({ class: 'schema-field' }, label(field.label), control, ...this.unvalidatedNote(field), errorSlot);
