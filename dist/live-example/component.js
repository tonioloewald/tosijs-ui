...
export class LiveExample extends Component {
    ...
    content = () => [
        ...
        }, codeEditor({ name: 'js', mode: 'javascript', part: 'js' }), codeEditor({ name: 'html', mode: 'html', part: 'html' }), codeEditor({ name: 'css', mode: 'css', part: 'css' }), codeEditor({ name: 'test', mode: 'javascript', part: 'test' }), div({ slot: 'after-tabs', class: 'row' }, button({
            title: 'undo',
            part: 'undo',
            class: 'transparent',
            onClick: this.undo,
