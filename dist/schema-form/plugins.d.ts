 ...
 */
export declare function registerFieldPlugin(format: string, plugin: FieldPlugin): void;
export declare function fieldPlugin(format: string | undefined): FieldPlugin | undefined;
/** Called with the newly-claimed format, so live forms using it can pick it up. */
export declare function onFieldPluginsChanged(listener: (format: string) => void): void;
/** Does this schema use `format` anywhere? What decides whether a form cares about a plugin. */
export declare function schemaUsesFormat(schema: JSONSchema | undefined, format: string): boolean;
