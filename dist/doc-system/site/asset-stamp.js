 ...
 */
export async function computeAssetStamp(paths, fallback) {
 ...
 */
export function missingStampInputWarning(missing) {
    return (`⚠️  asset stamp: ${missing.length} named input(s) did not exist and are NOT covered by ` +
