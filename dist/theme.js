 ...
 */
export function createDarkTheme(colors) {
 ...
 */
export function applyTheme(theme, id = 'tosi-theme') {
    StyleSheet(id, theme);
}
// ============================================================================
// Pre-built Themes
 ...
 */
export function createThemeWithLegacy(colors) {
 ...
 * ```
 */
export function componentVars(componentName, defaults) {
    const result = {};
