...
🇺🇸	🇫🇷	🇫🇮	🇸🇪	🇨🇳	🇯🇵	🇰🇷	🇪🇸	🇩🇪	🇮🇹
Ascending#sort-order	Ascendant	Nouseva	Stigande	升序	昇順	오름차순	Ascendente	Aufsteigend	Ascendente
...
Column#table	Colonne	Sarake	Kolumn	列	カラム	열	Columna	Spalte	Colonna
...
Descending#sort-order	Descendant	Laskeva	Fallande	降序	降順	내림차순	Descendente	Absteigend	Discendente
...
Left#direction	Gauche	Vasen	Vänster	左边	左	왼쪽	Izquierda	Links	Sinistra
...
Pin#fasten	Épingler	Kiinnitä	Fäst	固定	ピン留め	고정	Fijar	Anheften	Fissare
...
Unpin#unfasten	Désépingler	Irrota	Lossa	取消固定	ピン留め解除	고정 해제	Desfijar	Loslösen	Sbloccare
